...
# Eles nao estao registrados porque nao sao compativeis com a pipeline
# subaquatica atual do PatoSim.

# ===============================
#  Forklift C: tração + direção traseiras (sem Ackermann)
# ===============================
# =================================================================================================
# ROBÔ: 4 rodas, tração + direção NAS TRASEIRAS (sem Ackermann), compatível com PatoSim/Robot
# =================================================================================================
...
class FourWheelRearSteerRobot_V1(Robot):
    ...
    physics_dt: float = 0.01
    z_offset: float = 0.25
    # Attach custom sensors only to the primary PatoSim robot prim.
    ...
    usd_url: str = _resolve_asset_path(
        ...
        "/home/pdi_4/Documents/Documentos/bevlog-isaac/PatoSim/robot_assets/ForkliftC/forklift_c.usd",
        "/home/pdi_4/Documents/Documentos/bevlog-isaac/isaac-assets/"
        "isaac-sim-assets-robots_and_sensors-5.1.0/Assets/Isaac/5.1/Isaac/"
...
class ForkliftRobot(FourWheelRearSteerRobot_V1):
    ...
    def build(cls, prim_path: str) -> "ForkliftRobot":
        ...
        try:
            # front stereo
            from omni.ext.patosim.sensors import ZedStereoCamera, Camera, Lidar
            ...
            try:
                from omni.ext.patosim.sensors import _xform_translate, _xform_orient_quat
