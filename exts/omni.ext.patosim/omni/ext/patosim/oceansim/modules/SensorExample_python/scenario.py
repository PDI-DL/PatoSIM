...
########################################################################
    ...
    def setup_scenario(self, rob, sonar, cam, DVL, baro, ctrl_mode, camL, camR):
        self._rob = rob
        self._sonar = sonar
        self._cam = cam
        self._DVL = DVL
...
###########################stereo camera ###############################
        self._camL, self._camR = camL, camR
########################################################################
...
###########################stereo camera ###############################
        if self._camL is not None and self._camR is not None:
            self._camL.initialize()
            self._camR.initialize()
########################################################################
...
###########################stereo camera ###############################
        if self._camL is not None:
            self._camL.close()
        if self._camR is not None:
            self._camR.close()
        self._camL = None
        self._camR = None
#########################################################################
